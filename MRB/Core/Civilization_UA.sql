...
INSERT INTO	Types
		(Type,												Kind			)
VALUES	('ABILITY_PROTECTED_ROUTE',							'KIND_ABILITY'	),
		('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS',		'KIND_TRAIT'	);

INSERT INTO TypeTags
		(Type,												Tag				)
VALUES	('ABILITY_PROTECTED_ROUTE',							'CLASS_TRADER'	);

INSERT INTO UnitAbilities 
		(UnitAbilityType,
		Inactive)
VALUES	('ABILITY_PROTECTED_ROUTE',	
		1);

INSERT INTO UnitAbilityModifiers
		(UnitAbilityType,			ModifierId				)
VALUES	('ABILITY_PROTECTED_ROUTE',	'PROTECTED_LAND_ROUTE'	),
		('ABILITY_PROTECTED_ROUTE',	'PROTECTED_SEA_ROUTE'	);

INSERT INTO Modifiers
		(ModifierId,					ModifierType												)
VALUES	('PROTECTED_LAND_ROUTE',		'MODIFIER_PLAYER_UNIT_ADJUST_TRADE_ROUTE_PLUNDER_IMMUNITY'	),
		('PROTECTED_SEA_ROUTE',			'MODIFIER_PLAYER_UNIT_ADJUST_TRADE_ROUTE_PLUNDER_IMMUNITY'	);
-- Traits
INSERT INTO	Traits	
...
VALUES	('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS',		'TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS_ADJACENCY'		),
		('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS',		'TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS_PROTECTED_ROUTE'	),
...
VALUES	('INSTANT_TRADING_POST',										'MODIFIER_PLAYER_ADJUST_IMMEDIATE_TRADING_POST'	),
		('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS_PROTECTED_ROUTE',	'MODIFIER_PLAYER_UNITS_GRANT_ABILITY'			);
...
VALUES	('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS_ADJACENCY',			'YieldTypeToMirror',	'YIELD_GOLD'				),
		...
		('TRAIT_CIVILIZATION_BC_BACHIAN_WORK_ETHICS_PROTECTED_ROUTE',	'AbilityType',			'ABILITY_PROTECTED_ROUTE'	),
		('PROTECTED_LAND_ROUTE',										'DomainType',			'DOMAIN_LAND'				),	
		('PROTECTED_SEA_ROUTE',											'DomainType',			'DOMAIN_SEA'				),		
